...
<div class="row wrapper border-bottom white-bg page-heading push-bottom">
    <div class="col-lg-12">
        <h2><i class="<?php echo $icon; ?>"></i> <?php echo $title; ?>
            <a href="<?php echo base_url('user/personal/request_advance_pay'); ?>" class="btn btn-success btn-xs pull-right"><i class="fa fa-plus"></i> REQUEST ADVANCE PAY</a></h2>
        <ol class="breadcrumb">
        ...
        <div class="col-lg-12 animated fadeInRight">    
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Advance Pay Requests <small> Here you can view advance pay requests and their status.</small></h5>
