...
<div class="row wrapper border-bottom white-bg page-heading push-bottom">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li>Personal</li>
            <li><a href="<?php echo base_url('user/personal/trainings'); ?>">Training Requests</a></li>
        ...
        <div class="col-lg-12 animated fadeInRight">  
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form action="<?php echo (isset($training['id']) ? base_url()."employees/trainings_requests/edit/".$training['id'] : base_url('user/personal/request_training'));?>" class="form-horizontal" role="form" method="post">
