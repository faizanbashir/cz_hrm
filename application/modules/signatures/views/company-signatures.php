<?php include_once( APPPATH.'views/includes/header.php' ); ?>
    ...
    <div class="wrapper wrapper-content">
        <div class="row">
            <div class="col-md-12">  
                <a href="<?php echo base_url('signatures/signatures'); ?>" class="btn btn-danger m-b dim">Company Signatures</a>
                <a href="<?php echo base_url('signatures/signatures/custom_signatures'); ?>" class="btn btn-white m-b dim">Customized Signatures</a>
            </div>
        </div>
        <div class="row">
                                    ...
                                    <?php foreach($employees as $employee): ?>
                                        <tr class="gradeA">
                                            ...
                                            <td class="text-center">  
                                                ...
                                                <a href="<?php echo base_url('signatures/signatures/download_signature/company_signature/'.$employee['id']); ?>"><i class="fa fa-download fa-2x"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
    ...
    <script type="text/javascript">
        function sign(id){
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url("signatures/signatures/company_sign"); ?>',
                data: { 'id': id },
