        ...
        <div class="col-lg-12 animated fadeInRight">    
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form action="<?php echo base_url('employees/evaluation/rating'); ?>" method="POST">
                            ...
                            <tbody>
                                ...
                                ?> 
                                    <tr class="gradeA">
                                        ...
                                        <td class="text-center">
                                            <select required data-placeholder="Rate it..." class="chosen-select-no-single col-lg-12" name="concerned_head_rating[]">
                                                <option value=""></option>
                                                <?php for($i = 1; $i <= 10; $i++): ?>
                                    ...
                                    <input type="hidden" name="evaluation_id[]" value="<?php echo $question['id']; ?>"/>
                                    <input type="hidden" name="concerned_head_ratings[]" value="<?php echo $question['concerned_head_ratings']; ?>"/>
                                <?php endforeach; ?>
                            </tbody>                            
                        </table>
                        <button type="submit" class="btn btn-success pull-right">SUBMIT</button><br>
                    </form>
                </div>
            </div>
        </div>
